...
/* package haq-0.1.0.0 */
#define VERSION_haq "0.1.0.0"
#define MIN_VERSION_haq(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "haq-0.1.0.0-5EWJeZGltbNIhcBCV8wlT5"

#define CURRENT_PACKAGE_KEY "haq-0.1.0.0-5EWJeZGltbNIhcBCV8wlT5"
